...
##
This code was written by [ChristofferOK](https://github.com/christofferok) and only changed references from emojione to joypixels since they changed their name.
...
```bash
$ composer require "rawrkats/laravel-joypixels"
```
```bash
$ composer update
```
...
``` php
RawrSocial\LaravelJoyPixels\LaravelJoyPixelsServiceProvider::class,
```

Add this to the aliases array in `config/app.php`

``` php
'LaravelJoyPixels' => RawrSocial\LaravelJoyPixels\LaravelJoyPixelsFacade::class,
```

Config:

``` bash
$ php artisan vendor:publish --tag=config --provider="RawrSocial\LaravelJoyPixels\LaravelJoyPixelsServiceProvider"
```
...
``` bash
$ php artisan vendor:publish --tag=public --provider="RawrSocial\LaravelJoyPixels\LaravelJoyPixelsServiceProvider"
```
...
``` bash
$ php artisan vendor:publish --tag=sprites --provider="RawrSocial\LaravelJoyPixels\LaravelJoyPixelsServiceProvider"
```
